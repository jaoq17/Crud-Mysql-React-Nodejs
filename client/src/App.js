...
// Agregar Empleados  de la base de datos
...
// Actualizar Empleados  de la base de datos
...
// Eliminar Empleados  de la base de datos
  ...
  const deleteEmple = (val)=>{
    ...
    Swal.fire({
      title: "Confimar elimnacion?",
      html: "<i>Realmente dese eliminar a <strong>" + val.nombre  + "</strong>?</i>",
      icon: "warning",
      showCancelButton: true,
      confirmButtonColor: "#3085d6",
      cancelButtonColor: "#d33",
      confirmButtonText: "Sí, eiminarlo!"
    }).then((result) => {
